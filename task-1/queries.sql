...
VALUES ('Monerh', 'Al Sqyan', 'Saudi', 1993);
...
VALUES (
  ...
  2026,
  'Fiction',
  (SELECT id FROM authors WHERE first_name = 'Monerh' AND last_name = 'Al Sqyan')
);
...
DELETE FROM books
WHERE title = 'The Legends Of Moon'
  AND author_id = (SELECT id FROM authors WHERE first_name = 'Monerh' AND last_name = 'Al Sqyan');
---
